...
function xmldb_oublog_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2016051001) {
        // Rename field tags on table oublog to outags.
        $table = new xmldb_table('oublog');
        $field = new xmldb_field('tags', XMLDB_TYPE_CHAR, '255', null, null, null, null, 'introonpost');

        // Launch rename field outags.
        $dbman->rename_field($table, $field, 'outags');

        // Oublog savepoint reached.
        upgrade_mod_savepoint(true, 2016051001, 'oublog');
    }
